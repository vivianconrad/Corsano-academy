...
!(function(e, t) {
  ...
  (S.fn = S.prototype = {
    ...
    odd : function() {
      return this.pushStack(
          S.grep(this, function(e, t) { return t % 2; }),
      );
    },
    eq : function(e) {
  ...
  (S.filter = function(e, t, n) {
    ...
    return (n && (e = ":not(" + e + ")"),
            1 === t.length && 1 === r.nodeType
                ...
                : S.find.matches(
                      e,
                      S.grep(t, function(e) { return 1 === e.nodeType; }),
                      ));
  }), S.fn.extend({
    find : function(e) {
      ...
      S.each(
          {
            ...
            prevUntil : function(e, t,
                                 n) { return h(e, "previousSibling", n); },
            siblings : function(
           ...
           reliableTrDimensions : function() {
             ...
             return (null == a &&
                         ((e = E.createElement("table")),
                          ...
                          (a = 3 < parseInt(r.height)), re.removeChild(e)),
                     a);
           },
         }));
  })();
  ...
  (S.Animation = S.extend(ft, {
    ...
    prefilter : function(
      ...
      (S.fx.interval = 13),
      (S.fx.start = function() { nt || ((nt = !0), st()); }),
      ...
      ((rt = E.createElement("input")).value = "t"), (rt.type = "radio"),
    ...
    removeAttr : function(
      ...
      S.each(S.expr.match.bool.source.match(/\w+/g), function(e, t) {
        ...
        dt[t] = function(e, t, n) {
          ...
          return (n || ((i = dt[o]), (dt[o] = r),
                        (r = null != a(e, t, n) ? o : null), (dt[o] = i)),
                  r);
        };
      });
            ...
            r || e.isDefaultPrevented() ||
                ...
                (u && m(n[d]) && !x(n) &&
                 ((a = n[u]) && (n[u] = null), (S.event.triggered = d),
                  e.isPropagationStopped() && f.addEventListener(d, wt), n[d](),
  ...
  (S.proxy =
      ...
      (S.trim = function(
           e) { return null == e ? "" : (e + "").replace(Gt, ""); }),
      "function" == typeof define && define.amd &&
          define("jquery", [], function() { return S; });
  var Yt = C.jQuery, Qt = C.$;
  return ((S.noConflict = function(e) {
            return C.$ === S && (C.$ = Qt),
                   e && C.jQuery === S && (C.jQuery = Yt), S;
